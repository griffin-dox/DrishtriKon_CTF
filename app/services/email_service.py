...
def send_otp(recipient_email, username, otp_code):
    try:
        ...
        if MAIL_USERNAME is None or MAIL_PASSWORD is None or MAIL_DEFAULT_SENDER is None:
          raise ValueError("MAIL_USERNAME, MAIL_PASSWORD, and MAIL_DEFAULT_SENDER environment variables must be set.")
