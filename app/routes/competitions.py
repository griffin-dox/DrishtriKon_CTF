...
from app.models import Competition, CompetitionStatus, User, UserCompetition, UserRole
from sqlalchemy import desc
from datetime import datetime
from app.forms import TeamCompetitionRegisterForm
from app.services.cache.utils import cached_query, invalidate_cache
...
@rate_limit_route(
    ...
    message="Too many competition registration attempts.",
    methods={"POST"},
)
def register(competition_id):
    ...
    user_competition.user_id = current_user.id
    user_competition.competition_id = competition_id
    user_competition.score = 0
...
@rate_limit_route(
    ...
    3600,
    identifier_func=user_or_ip_identifier,
    message="Too many competition unregistration attempts.",
    methods={"POST"},
)
