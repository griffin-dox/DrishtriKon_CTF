...
from app.models import Challenge, Submission, CompetitionChallenge, Competition, User, UserCompetition, ChallengeVisibilityScope
from app.forms import FlagSubmissionForm
...
def view_challenge(challenge_id):
    ...
    if form.validate_on_submit():
        ...
        submission.flag_submitted = form.flag.data
        submission.is_correct = is_correct
        submission.points_awarded = challenge.points if is_correct else 0
